...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#kosten0Nord").html(kostenNord0+",- € <br> Rechnet sich nach ca "+JahreNord0+" Jahren und "+ MonatNord0+" Monaten");
        $("#kosten0West").html(kostenWest0+",- € <br> Rechnet sich nach ca "+JahreWest0+" Jahren und " +MonatWest0 + "Monaten");
        $("#kosten0Ost").html(kostenOst0+",- € <br> Rechnet sich nach ca "+JahreOst0+" Jahren und "+MonatOdt0+ " Monate");
        $("#kosten0Sued").html(kostenSued0+",- € <br> Rechnet sich nach ca "+JahreSued0+" Jahren und " + MonatSued0+ "Moante");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        let Jahrensued30 = Math.round(  (kostenSued30 /kostenjahr)*12 );
         ...
         // Zuweisung Kosten 30°
        $("#kosten30Nord").html(kostenNord30+",- € <br> Rechnet sich nach ca "+JahreNord30+ " Jahren und "+MonatNord30+" Monaten");
        $("#kosten30West").html(kostenWest30+",- € <br> Rechnet sich nach ca "+JahreWest30+" Jahen und " + MonatWest30+ "Monaten");
        $("#kosten30Ost").html(kostenOst30+",- € <br> Rechnet sich nach ca "+JahreOst30+" Jahren und "+MonatOst30+" Monaten");
        $("#kosten30Sued").html(kostenSued30+",- € <br> Rechnet sich nach ca "+JahreSued30+" Jahren und "+ MonatSued30+ "Monaten");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         // Zuweisung Kosten 45° 
         $("#kosten45Nord").html(kostenNord45+",- € <br> Rechnet sich nach ca "+JahreNord45+" Jahren und "+MonatNord45+" Monaten");
